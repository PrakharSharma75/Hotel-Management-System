...
public class Updateroom extends JFrame implements ActionListener{
    ...
    Choice ccustomer;
    JTextField tfroom, tfavailable, tfstatus, tfamount, tfamountpending;
    ...
    Updateroom(){
        ...
        ImageIcon l1 = new ImageIcon(ClassLoader.getSystemResource("Images/seventh.jpg"));
        Image i2 = l1.getImage().getScaledInstance(500, 300, Image.SCALE_DEFAULT);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == check){
          ...
          String available = tfavailable.getSelectedText();
          String status = tfstatus.getSelectedText();
